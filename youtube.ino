...
#include <Max7219Panel.h>        // Display library
#include <ArduinoJson.h>         // ArduinoJson library for JSON parsing
//this code funciobn is to have matrix with valuable
// Wi-Fi credentials
...
const String type = "youtubeuser";  // Replace with your desired API type
const String url = "https://www.googleapis.com/youtube/v3/channels?part=statistics&id=$" + type "&key=" + key;
